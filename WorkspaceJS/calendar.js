// js/calendar.js — uses DAYS from config.js (loaded globally)
...
function renderCalendarMonth() {
    ...
    // Use actual day names starting from Sunday
    ...
    for (let d = 1; d <= daysInMonth; d++) {
        ...
        // Derive full day name from day-of-week index (0=Sunday)
...
function selectCalendarDate(dateStr, dayName) {
    ...
    // Auto-trigger countdown for dates more than 30 days away
